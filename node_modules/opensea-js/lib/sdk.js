...
var OpenSeaSDK = /** @class */ (function () {
    ...
    OpenSeaSDK.prototype.getFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var openseaSellerFeeBasisPoints, collectionSellerFeeBasisPoints, openseaBuyerFeeBasisPoints, collectionBuyerFeeBasisPoints, sellerBasisPoints, getConsiderationItem, getConsiderationItemsFromSellerFees;
            var _this = this;
    ...
    OpenSeaSDK.prototype.createBuyOrder = function (_a) {
        var _b;
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _c = _a.quantity, quantity = _c === void 0 ? 1 : _c, expirationTime = _a.expirationTime, paymentTokenAddress = _a.paymentTokenAddress;
        return __awaiter(this, void 0, void 0, function () {
            var openseaAsset, considerationAssetItems, basePrice, _d, openseaSellerFee, collectionSellerFees, considerationFeeItems, executeAllActions, order;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        _d = _e.sent(), openseaSellerFee = _d.openseaSellerFee, collectionSellerFees = _d.collectionSellerFees;
    ...
    OpenSeaSDK.prototype.createSellOrder = function (_a) {
        var _b;
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _c = _a.quantity, quantity = _c === void 0 ? 1 : _c, listingTime = _a.listingTime, expirationTime = _a.expirationTime, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? constants_2.NULL_ADDRESS : _d, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var openseaAsset, offerAssetItems, _e, basePrice, endPrice, _f, sellerFee, openseaSellerFee, collectionSellerFees, considerationFeeItems, executeAllActions, order;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3:
                        _f = _g.sent(), sellerFee = _f.sellerFee, openseaSellerFee = _f.openseaSellerFee, collectionSellerFees = _f.collectionSellerFees;
                        considerationFeeItems = [
                            sellerFee,
                            openseaSellerFee,
                            collectionSellerFees,
